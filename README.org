...
- [[file:240207_1-leak-pairing-10cm-anechoic-2.533e9-8e6_raw]] ::
  ...
  - Profiled using phase, unusable profile but with a start of correlation.
  - Attack using amplitude profile converge up to 2^80 key rank using 4k
    traces, needs more traces to see maximum convergence.
