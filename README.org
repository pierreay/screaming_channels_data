...
This repository is managed using [[https://git-annex.branchable.com/][git-annex]]. Around 400 GB of data is currently
deduplicated and spread across 4 computers (=reaper=, =saren=, =wrex=,
=citadel=) and 2 external mass storage devices (=garrus=, =novigrad=).

A vary small part of this repository is uploaded on Zenodo. See:
#+begin_quote
...
again. Hence, in the [[file:screaming_channels_ble.log][screaming_channels_ble.log]] file, you will find a list of
