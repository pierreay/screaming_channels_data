...
Companion repository of the "Screaming Channels on Bluetooth Low Energy" project.

See the [[https://github.com/pierreay/screaming_channels_data][screaming_channels_ble]] repository for a complete overview of the
project.

* Usage

This repository is managed using [[https://git-annex.branchable.com/][git-annex]]. The data is currently spread across
3 computers (=reaper=, =saren=, =wrex=, =citadel=) and 2 external mass storage
