...
- Hardware setup ::
  - Identical to [[id:c2b4dc98-bf62-4225-8dfe-da6e02967282][[2024-04-23 mar.] Custom firmware at high distance using 2 LNAs without repetitions with increased gain]].
- Software setup ::
  - Radio configuration ::
    - Center frequency = 2.533 GHz
    - Sampling rate = 8e6 Msps
    - Gain = 70 dB
  - Sets ::
    - Training set = 16k traces using ~300 repetitions
    - Attack set = 16k traces using ~300 repetitions =avg= and no repetition for
      =ext=
- Results ::
  - Summary in [[attachment:plots/attack_all.pdf]].
  - Using the [[attachment:avg/profiles/AMPLITUDE_16000_r_2/]] profile, we lower
    the key rank down to 2^30 (key found).
  - No correlations found on phase rotation.
...
- Hardware setup ::
  - Identical to [[id:c2b4dc98-bf62-4225-8dfe-da6e02967282][[2024-04-23 mar.] Custom firmware at high distance using 2
    LNAs without repetitions with increased gain]]
- Software setup ::
  - Identical to [[id:0936568c-d3f9-4c18-841f-5dadecf0118a][[2024-04-23 mar.] Nimble at high distance using 2 LNAs and
    repetitions with increased gain]]
  - Firmware : original without repetitions
  - Train set = XXX traces
  - Attack set = 40k traces
- Results ::
  - Using profile of [[id:0936568c-d3f9-4c18-841f-5dadecf0118a][[2024-04-23 mar.] Nimble at high distance using 2 LNAs and
    repetitions with increased gain]], it cannot be reused on this dataset
    because the profile is slightly different than actual attacked traces.
  - Using internal profile, XXX.
