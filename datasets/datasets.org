...
| Name | Profile  | Nb. traces * Nb. AES | Key rank | Median(PGE) | Hamming dist. |
|------+----------+----------------------+----------+-------------+---------------|
| A0   | External | 16000 * 300          |    2^127 |         128 |            64 |
| A1   | P0       | 30000 * 1            |     2^60 |           7 |            27 |
...
- Comments ::
  1. Attack =A0= is the attempt of profile re-usage from instrumented Nimble to
     non-instrumented Nimble (=AMPLITUDE_16000_r_1= from [[id:0936568c-d3f9-4c18-841f-5dadecf0118a][[2024-04-23 mar.]​]]).
     However, the profile is statistically slightly different than actual
     attacked traces making the re-usage impossible.
