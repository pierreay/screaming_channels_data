...
./attack.py --plot --norm --dataset-path ~/storage/dataset/single_cable_raw --num-traces 2500 --start-point 73600 --end-point 74000 attack --attack-algo pcc --num-pois 2 --poi-spacing 2 --variable p_xor_k --align
