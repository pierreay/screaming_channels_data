...
#TODO: Implement an interactive mode where we can trigger the BLE com. with and
#without the radio. Allowing to quickly make external measurement (gqrx) and
#don't wait radio initialization every time.
