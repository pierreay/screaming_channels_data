...
class MySoapySDR():
    def __init__(self, fs, freq, gain):
        l.LOGGER.debug("MySoapySDR.__init__(fs={},freq={}, gain={})".format(fs, freq, gain))
        self.fs = fs
        self.freq = freq
        results = SoapySDR.Device.enumerate()
        self.sdr = SoapySDR.Device(results[1])
...
if __name__ == "__main__":
    ...
    rad = MySoapySDR(file_config.radio.sampling_rate, file_config.radio.target_freq, file_config.radio.usrp_gain)
    rad.open()
