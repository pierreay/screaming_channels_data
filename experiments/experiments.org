...
- Compared to [[id:11b1c7e1-8793-41ca-9a5e-1db6d355692c][[2024-05-15 mer.] LDO]], profile is different (both correlation and
  values). We expected to see a higher standard deviation in the values since
  the MCU should consume less energy, but we observer the opposite.

** [2024-05-15 mer.] Profiling with ICACHE enabled
:PROPERTIES:
